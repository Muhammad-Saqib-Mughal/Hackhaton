...
function Hthird() {
    return (
        <>
            <div className='mt-16 flex flex-col space-y-14'>
                ...
                <div className=' flex flex-col items-center space-y-10'>
                    ...
                    <div className='grid grid-cols-4 items-center justify-center gap-6 lg:grid-cols-2 lg:gap-1'>
                        ...
                        <div className='w-auto'>
                            ...
                            <div className=' flex gap-1'>
                                ...
                                <img src="/images/home/star-1.png" alt="" />
                                <img src="/images/home/star-1.png" alt="" />
                                <img src="/images/home/star-5.png" alt="" />
                    ...
                    <button className='mx-5 h-[52px] w-[218px] border rounded-full '>View All</button>
                </div>
