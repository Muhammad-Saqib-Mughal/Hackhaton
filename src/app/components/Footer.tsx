            ...
            <div className='flex flex-col items-center'>
                <div className='flex lg:flex-col lg:items-center justify-between items-center bg-black text-white p-8 w-[90%] rounded-2xl relative z-10 top-24'>
                    ...
                    <div className='flex flex-col space-y-3'>
                        <span className='w-[340px] h-[48px] rounded-full bg-white flex items-center p-5 gap-3 ' ><img src="/images/nav/mail.png" alt="" /> <input className='outline-none' type="text" placeholder='Enter your email address' /></span>
                        
                        <button className='w-[340px] h-[48px] bg-white text-black rounded-full'>Subscribe to Newsletter</button>
                    </div>
                </div>


                <div className='bg-[#F0F0F0] p-20 space-y-5 '>
                    <div className='h-14'></div>

                    <div className='grid grid-cols-5 justify-center space-x-4 lg:grid-cols-2 lg:space-y-5'>

                        <div className='flex flex-col space-y-5 gridf'>
                            <div>
